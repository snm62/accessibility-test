...
body.big-black-cursor {
    cursor: url('data:image/svg+xml;base64, [... truncated] ...'), auto !important;
}
...
body.big-white-cursor {
    cursor: url('data:image/svg+xml;base64, [... truncated] ...'), auto !important;
}
...
body.big-white-cursor * {
    ...
    async fetchCustomizationData() {
     ...
     // Add this method to force refresh customization data
async refreshCustomizationData() {
    console.log('[CK] refreshCustomizationData() - Force refreshing customization data...');
    ...
    try {
        ...
        if (customizationData && customizationData.customization) {
            console.log('[CK] refreshCustomizationData() - Applying fresh customization data:', customizationData.customization);
            this.applyCustomizations(customizationData.customization);
            return true;
        } else {
            console.log('[CK] refreshCustomizationData() - No customization data found');
            return false;
        }
    } catch (error) {
        console.error('[CK] refreshCustomizationData() - Error:', error);
        return false;
    }
}
// Add this method to check for updates periodically
startUpdateChecker() {
    // Check for updates every 30 seconds
    setInterval(async () => {
        try {
            console.log('[CK] Checking for customization updates...');
            const customizationData = await this.fetchCustomizationData();
            
            if (customizationData && customizationData.customization) {
                // Check if customization data has changed
                const currentData = JSON.stringify(this.customizationData);
                const newData = JSON.stringify(customizationData.customization);
                
                if (currentData !== newData) {
                    console.log('[CK] Customization data has changed, applying updates...');
                    this.applyCustomizations(customizationData.customization);
                }
            }
        } catch (error) {
            console.error('[CK] Update checker error:', error);
        }
